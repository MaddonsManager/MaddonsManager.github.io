    ...
    cardTitles: [
        {
            ...
            icon: <MonitorMobileIcon size={24} width={24} height={24} />
        },
        {
            ...
            icon: <SearchIcon size={24} width={24} height={24} />
        },
        {
            ...
            icon: <EditDocumentIcon size={24} width={24} height={24} />
        },
        {
            title: 'Easy Removal',
            description:
            ...
            icon: <DeleteIcon size={24} width={24} height={24} />
        }
    ]
}
